...
import { SHOW_RETURNS_CLIENT } from 'src/utils/featureToggles';
import ReturnsClientComp from './ReturnsClient';

const ReturnsClient: React.FC = () => {
  ...
  useEffect(() => {
    if (!user || !SHOW_RETURNS_CLIENT) return;

    setTitles({
      title: 'Devoluciones de Libros a Cliente',
